    ...
    public class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Visual
                ...
                new ButtonInfo { buttonText = "Bone ESP", method =() => Visual.BoneESP(), disableMethod =() => Visual.DisableBoneESP(), isTogglable = true, toolTip = "Gives people bones on ththey'reere body." },
                new ButtonInfo { buttonText = "Self Bone ESP", method =() => Visual.SelfBoneESP(), disableMethod =() => Visual.DisableSelfBoneESP(), isTogglable = true, toolTip = "Gives you bones on ththey'reere body." },
