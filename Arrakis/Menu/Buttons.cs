    ...
    public class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Menu Settings
                ...
                new ButtonInfo { buttonText = "Change Click Sound", overlapText = "Change Click Sound <color=grey>[<color=cyan>buttonpress</color>]</color>", method =() => ChangeClickSound(), isTogglable = false, toolTip = "Changes the click sound of the menu buttons.", ShowInArraylist = false },
            ...
            new ButtonInfo[] { // Safety
                ...
                new ButtonInfo { buttonText = "AntiCrash", method =() => Safety.AntiCrash(), isTogglable = true, toolTip = "Attemts to bypass laggers/crashers by clearing the rpc queue." },
            ...
            new ButtonInfo[] { // Sound
                ...
                new ButtonInfo { buttonText = "Snow Spam <color=grey>[<color=cyan>B</color>]</color>", method =() => Sound.SoundSpam(32), isTogglable = true, toolTip = "Spams the snow sound when you hold <color=grey>[<color=cyan>B</color>]</color>." },
                new ButtonInfo { buttonText = "Hand Tap Spam <color=grey>[<color=cyan>B</color>]</color>", method =() => Sound.SoundSpam(1), isTogglable = true, toolTip = "Spams the handtap sound when you hold <color=grey>[<color=cyan>B</color>]</color>." },
                new ButtonInfo { buttonText = "Glass Spam <color=grey>[<color=cyan>B</color>]</color>", method =() => Sound.SoundSpam(22), isTogglable = true, toolTip = "Spams the glass sound when you hold <color=grey>[<color=cyan>B</color>]</color>." },
                new ButtonInfo { buttonText = "Jman Yell Spam <color=grey>[<color=cyan>B</color>]</color>", method =() => Sound.SoundSpam(337), isTogglable = true, toolTip = "Spams the jman yell sound when you hold <color=grey>[<color=cyan>B</color>]</color>." },
                new ButtonInfo { buttonText = "Jman Okay Spam <color=grey>[<color=cyan>B</color>]</color>", method =() => Sound.SoundSpam(336), isTogglable = true, toolTip = "Spams the jman okay sound when you hold <color=grey>[<color=cyan>B</color>]</color>." },
                new ButtonInfo { buttonText = "Jman Slap Spam <color=grey>[<color=cyan>B</color>]</color>", method =() => Sound.SoundSpam(338), isTogglable = true, toolTip = "Spams the jman slap sound when you hold <color=grey>[<color=cyan>B</color>]</color>." },
                new ButtonInfo { buttonText = "Random Spam <color=grey>[<color=cyan>B</color>]</color>", method =() => Sound.SoundSpam(UnityEngine.Random.Range(0, 350)), isTogglable = true, toolTip = "Spams the glass sound when you hold <color=grey>[<color=cyan>B</color>]</color>." },
            },
            ...
            new ButtonInfo[] { // Fun
                ...
                new ButtonInfo { buttonText = "Max Quest Score", method =() => Fun.WaterGun(), isTogglable = false, toolTip = "Gives you the max quest score." },
                ...
                new ButtonInfo { buttonText = "Invisable Rig", enableMethod =() => Fun.InvisableRig(true),disableMethod  =() =>  Fun.InvisableRig(false), isTogglable = true, toolTip = "Makes your rig invisable ss need to rejoin for others to see rig again." },
            ...
            new ButtonInfo[] { // Overpowered
                ...
                new ButtonInfo { buttonText = "Big Stutter All", method =() => Overpowered.LagAll(1900, 4f), isTogglable = true, toolTip = "Lags everyone, this may kick you, dosnt seem to work on steam players." },
                new ButtonInfo { buttonText = "Strong Lag All", method =() => Overpowered.LagAll(625, 1.5f), isTogglable = true, toolTip = "Lags everyone, this may kick you, dosnt seem to work on steam players." },
                new ButtonInfo { buttonText = "Lag All", method =() => Overpowered.LagAll(275, 0.5f), isTogglable = true, toolTip = "Lags everyone, this may kick you, dosnt seem to work on steam players." },
            ...
            new ButtonInfo[] { // Soundboard
                ...
                new ButtonInfo { buttonText = "I SELL CRACK! - ISSBROKIE", enableMethod =() => Soundboard.Play("https://cdn.discordapp.com/attachments/1531554219046342696/1531557504100728913/I_SELL_CRACK_-_ISSBROKIE.mp3?ex=6a69a593&is=6a685413&hm=c1ec1d47f7913e85b794ec5a2a2983526a3b846daf06a2699dc6cf111464051b&"), disableMethod =() => Soundboard.Stop(), isTogglable = true, toolTip = "Plays a sound/song." },
                new ButtonInfo { buttonText = "Nicky - Tommy Ragen", enableMethod =() => Soundboard.Play("https://cdn.discordapp.com/attachments/1531554219046342696/1531557528842928158/Nicky_-_Tommy_Ragen.mp3?ex=6a69a599&is=6a685419&hm=525ecfe61281fc3e2031d4b7b66c6c124a8b0b5701d03989f8644354fb29a83b&"), disableMethod =() => Soundboard.Stop(), isTogglable = true, toolTip = "Plays a sound/song." },
                new ButtonInfo { buttonText = "ttm - Roombound!", enableMethod =() => Soundboard.Play("https://cdn.discordapp.com/attachments/1531554219046342696/1531557551462678568/ttm_-_roombound.mp3?ex=6a69a59f&is=6a68541f&hm=bd52842e85dd554d84238962f7eb8a7fd73f9521980a435a7ce5f597cec9f46d&"), disableMethod =() => Soundboard.Stop(), isTogglable = true, toolTip = "Plays a sound/song." },
                new ButtonInfo { buttonText = "ARE WE STILL FRIENDS. - Tyler The Creator", enableMethod =() => Soundboard.Play("https://cdn.discordapp.com/attachments/1531554219046342696/1531559063781904424/ARE_WE_STILL_FRIENDS.mp3?ex=6a69a707&is=6a685587&hm=afe41c6da38a097947ba5ad22dd03c77033cbcbdaba0a2ed48142f2220a61c97&"), disableMethod =() => Soundboard.Stop(), isTogglable = true, toolTip = "Plays a sound/song." },
                new ButtonInfo { buttonText = "Who is she. - I Monster", enableMethod =() => Soundboard.Play("https://cdn.discordapp.com/attachments/1531554219046342696/1531559064461512704/Who_Is_She.mp3?ex=6a69a707&is=6a685587&hm=f0419ecbb1f37cc885d37f9dd646eb6e3c4d8e7160672473f3c8f14bf91c1880&"), disableMethod =() => Soundboard.Stop(), isTogglable = true, toolTip = "Plays a sound/song." },
                new ButtonInfo { buttonText = "Death Bed. - Powfu", enableMethod =() => Soundboard.Play("https://cdn.discordapp.com/attachments/1531554219046342696/1531564024586834071/Death_Bed_Sound.ogg?ex=6a69aba6&is=6a685a26&hm=222b8d3a9ee1a357e272e753a375ff8a6911e1c0b93e1c8622aa6a5f25f8a027&"), disableMethod =() => Soundboard.Stop(), isTogglable = true, toolTip = "Plays a sound/song." },
                new ButtonInfo { buttonText = "Nope Your Too Late I Already Died. - Wifiskeleton", enableMethod =() => Soundboard.Play("https://cdn.discordapp.com/attachments/1531554219046342696/1531564559033172099/Nope_Your_Too_Late_I_Already_Died_Sound.ogg?ex=6a69ac25&is=6a685aa5&hm=c879a364511151b0ce0e00a1bdf074365db62ea5c873fe5cd739f4b794b1578f&"), disableMethod =() => Soundboard.Stop(), isTogglable = true, toolTip = "Plays a sound/song." },
                new ButtonInfo { buttonText = "My Castle Town. - Toby Fox", enableMethod =() => Soundboard.Play("https://cdn.discordapp.com/attachments/1531554219046342696/1532361399517577236/3._My_Castle_Town_DELTARUNE_Chapter_2_Soundtrack_-_Toby_Fox.mp3?ex=6a6c9243&is=6a6b40c3&hm=7c7ec7a991940868fe740d779a50d1be818b7e34996cc5dc1a65d76025c48329&"), disableMethod =() => Soundboard.Stop(), isTogglable = true, toolTip = "Plays a sound/song." },
                new ButtonInfo { buttonText = "ATTACHED!. - D3r", enableMethod =() => Soundboard.Play("https://cdn.discordapp.com/attachments/1531554219046342696/1532361423273857054/ATTACHED.mp3?ex=6a6c9249&is=6a6b40c9&hm=2f1f1891fccaa79eff6b5b290853c2d509179f015b54eb226f45a510bff16ed7&"), disableMethod =() => Soundboard.Stop(), isTogglable = true, toolTip = "Plays a sound/song." },
                new ButtonInfo { buttonText = "Russian song hardstyle. - Idfk", enableMethod =() => Soundboard.Play("https://cdn.discordapp.com/attachments/1531554219046342696/1532362003048304650/Hardstyle_Remix.mp3?ex=6a6c92d3&is=6a6b4153&hm=a05d9abac01511b74070d2d720599c46bd53e7e168a0cac201920a2d357c408a&"), disableMethod =() => Soundboard.Stop(), isTogglable = true, toolTip = "Plays a sound/song." },
                new ButtonInfo { buttonText = "whenamachaintesumma. - Idfk", enableMethod =() => Soundboard.Play("https://cdn.discordapp.com/attachments/1531554219046342696/1532361881883250859/whenamachaintesumma.mp3?ex=6a6c92b6&is=6a6b4136&hm=3c0206054792c2e3c7d0c267c0b7f3d3a4b09f1e78f77dcce1a9127797f9b432&"), disableMethod =() => Soundboard.Stop(), isTogglable = true, toolTip = "Plays a sound/song." },
                new ButtonInfo { buttonText = "Suffer. - Petit Biscuit", enableMethod =() => Soundboard.Play("https://cdn.discordapp.com/attachments/1531554219046342696/1532361604992073829/Petit_Biscuit_-_Suffer_Ft._Skott_Lyrics.mp3?ex=6a6c9274&is=6a6b40f4&hm=520d1563e1866f077bc222ab7827a627f9eb88215f40959e1a0739a7ccfa2cf2&"), disableMethod =() => Soundboard.Stop(), isTogglable = true, toolTip = "Plays a sound/song." },
                new ButtonInfo { buttonText = "616 In LA. - Kendrick Lamar", enableMethod =() => Soundboard.Play("https://cdn.discordapp.com/attachments/1531554219046342696/1532361399190159403/616_In_LA_-_Kendrick_Lamar.mp3?ex=6a6c9243&is=6a6b40c3&hm=4fd06fbb66d5fd7bf18d891d8285699c95dcb86ac95baa475083df90e766f33d&"), disableMethod =() => Soundboard.Stop(), isTogglable = true, toolTip = "Plays a sound/song." },
                new ButtonInfo { buttonText = "Acid Tunnel. - Toby Fox", enableMethod =() => Soundboard.Play("https://cdn.discordapp.com/attachments/1531554219046342696/1532364165833035907/acid_tunnel.ogg?ex=6a6c94d7&is=6a6b4357&hm=706d7557a001f0c5ecd1c2c32c8aada28fe53800831ef53dc277fb2e8c4891c5&"), disableMethod =() => Soundboard.Stop(), isTogglable = true, toolTip = "Plays a sound/song." },
                new ButtonInfo { buttonText = "Field Of Hopes. - Toby Fox", enableMethod =() => Soundboard.Play("https://cdn.discordapp.com/attachments/1531554219046342696/1532364936406110268/field_of_hopes.ogg?ex=6a6c958e&is=6a6b440e&hm=9a8c1ae28a85a307f074c79311fd5227300fb8f9cd1bcac0c46a87f81fcc162b&"), disableMethod =() => Soundboard.Stop(), isTogglable = true, toolTip = "Plays a sound/song." },
                new ButtonInfo { buttonText = "field Of Hopes Insaneintherain Loop. - Toby Fox", enableMethod =() => Soundboard.Play("https://cdn.discordapp.com/attachments/1531554219046342696/1532365043470041088/field_of_hopes_insaneintherain_loop.ogg?ex=6a6c95a8&is=6a6b4428&hm=21d8826b2eb38852ca02697db4389decfd37ed15e3e0136bc57fd3d19119a525&"), disableMethod =() => Soundboard.Stop(), isTogglable = true, toolTip = "Plays a sound/song." },
                //new ButtonInfo { buttonText = "song name. - artist", enableMethod =() => Soundboard.Play(""), disableMethod =() => Soundboard.Stop(), isTogglable = true, toolTip = "Plays a sound/song." },
            },
            ...
            new ButtonInfo[] { // Internal
                ...
                new ButtonInfo { buttonText = "Keyboard", isTogglable = false },
            },
        };
