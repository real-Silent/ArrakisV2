    ...
    public class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Overpowered
                ...
                new ButtonInfo { buttonText = "Big Stutter All", method =() => Overpowered.LagAll(1900, 4.3f), isTogglable = true, toolTip = "Lags everyone, this may kick you, dosnt seem to work on steam players." },
                new ButtonInfo { buttonText = "Strong Lag All", method =() => Overpowered.LagAll(625, 1.7f), isTogglable = true, toolTip = "Lags everyone, this may kick you, dosnt seem to work on steam players." },
                new ButtonInfo { buttonText = "Lag All", method =() => Overpowered.LagAll(275, 0.7f), isTogglable = true, toolTip = "Lags everyone, this may kick you, dosnt seem to work on steam players." },
