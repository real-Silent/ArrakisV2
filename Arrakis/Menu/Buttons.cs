    ...
    public class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Overpowered
                ...
                new ButtonInfo { buttonText = "Strong Lag All", method =() => Overpowered.LagAll(1350, 3f), isTogglable = true, toolTip = "Lags everyone, this may kick you, dosnt seem to work on steam players." },
                new ButtonInfo { buttonText = "Lag All", method =() => Overpowered.LagAll(340, 1f), isTogglable = true, toolTip = "Lags everyone, this may kick you, dosnt seem to work on steam players." },
